...
PICS = (environ.get('PICS', 'https://i.ibb.co/0p0jYbz7/f1b7439b43eb.jpg')).split()  # Sample pic
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002501776853'))  # Log channel id (make sure bot is admin)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002812137593'))  # Premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002621817685')  # Request channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DISHA:DISHA@cluster0.tu2coev.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://JHATU:JHATU@cluster0.4189nhu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
